                ...
                <section class="panel">
                    ...
                    <div class="panel-body">                        
                        ...
                        <p></p>
                            ...
                            <div class="form-group">
                                <label for="exampleInputDes">Topic Description</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputStatus">Topic Status</label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputImage">Image Topic</label>
                                <input type="file" name="course_image" class="form-control" id="exampleInputImage">
                            </div>
                            <center><button type="submit" name="edit_course" class="btn btn-info">Edit Topic</button></center>
                        </form>
                        @endforeach
                        </div>
