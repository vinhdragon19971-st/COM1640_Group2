                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                <label for="exampleInputImageCourse">Image Topic</label>
                                <input type="file" name="course_image" class="form-control" id="exampleInputImageCourse">
                            </div>
                            <center><button type="submit" name="create_course" class="btn btn-info">Create Topic</button></center>
                        </form>
                        </div>
